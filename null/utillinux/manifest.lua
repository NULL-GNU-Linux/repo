...
function pkg.source()
	return function(hook)
		hook("prepare")(function()
		    exec("./autogen.sh")
			local configure_opts = { "--prefix=/usr", "ac_cv_func_rpmatch=yes", "ac_cv_func_reallocarray=yes", "CFLAGS='-Wno-error=implicit-function-declaration -include stdio.h -include stdlib.h -Wno-error -D_GNU_SOURCE'", "CC='gcc -std=gnu11'" }
